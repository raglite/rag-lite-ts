...
import { openDatabase, initializeSchema, insertDocument, insertChunk, setStoredModelInfo } from '../../src/core/db.js';
import { getModelDefaults } from '../../src/core/config.js';
import type { DatabaseConnection } from '../../src/core/db.js';
  ...
  test('should allow rebuild with new model after mismatch', async () => {
    ...
    try {
      ...
      try {
        ...
        const { getStoredModelInfo } = await import('../../src/core/db.js');
