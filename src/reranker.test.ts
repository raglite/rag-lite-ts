...
describe('CrossEncoderReranker', () => {
  ...
  test('should throw error when reranking without loaded model', async () => {
    ...
    const results: SearchResult[] = [{
      text: 'test document',
      score: 0.8,
      document: { id: 1, source: 'test.md', title: 'Test' }
    }];
    ...
    const originalResults: SearchResult[] = [
      {
        ...
        score: 0.9,
        document: { id: 1, source: 'doc1.md', title: 'ML Doc' }
      },
      {
        text: 'second document about databases',
        score: 0.7,
        document: { id: 2, source: 'doc2.md', title: 'DB Doc' }
      }
    ];
    ...
    const results: SearchResult[] = [
      {
        ...
        score: 0.8,
        document: { id: 1, source: 'ml.md', title: 'ML Basics' }
      },
      {
        text: 'Database systems store and retrieve data efficiently',
        score: 0.6,
        document: { id: 2, source: 'db.md', title: 'Database Systems' }
      }
    ];
