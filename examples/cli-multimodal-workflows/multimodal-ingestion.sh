...
echo "Command: raglite ingest sample-content/multimodal/ --mode multimodal"
echo ""
echo "This would use filename-based reranking for faster results."
echo ""

echo "Example 2: Disabled reranking"
echo "Command: raglite ingest sample-content/multimodal/ --mode multimodal --no-rerank"
echo ""
...
echo "  - text-derived: Best for semantic search (default)"
