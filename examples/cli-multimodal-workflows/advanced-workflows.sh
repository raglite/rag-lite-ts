...
echo "   Fast: --no-rerank"
echo "   Quality: --rerank (default behavior)"
echo ""
...
echo "  Speed: --no-rerank"
echo "  Quality: --rerank (automatic for multimodal)"
echo ""
...
echo ""
echo "Step 3: Enable reranking for quality"
echo "  Command: raglite ingest ./products/ --mode multimodal"
echo ""
